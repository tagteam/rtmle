...
## Version: 
## Last-Updated: Oct 25 2024 (18:32) 
...
set.seed(17)
ld <- simulate_long_data(n = 13,number_visits = 20,beta = list(A_on_Y = -.2,A0_on_Y = -0.3,A0_on_A = 6),register_format = TRUE)
