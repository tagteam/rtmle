...
x <- regime(x,name = "Use_A_not_B_in_the_end",intervention = data.frame(time = x$intervention_nodes,A = factor(c(NA,NA,NA,rep("1",2)),levels = c("0", "1")),B = factor(c(NA,NA,NA,"0","0"),levels = c("0", "1"))),verbose = FALSE)
x <- regime(x,name = "Always_A_not_B_in_the_beginning",intervention = data.frame(time = x$intervention_nodes,A = factor(rep("1",5),levels = c("0", "1")),B = factor(c("0","0",NA,NA,NA),levels = c("0", "1"))),verbose = FALSE)
x <- target(x,name = "Stroke_risk",regimes = c("Use_A_not_B_in_the_end", "Always_A_not_B_in_the_beginning"),estimator = "tmle")
