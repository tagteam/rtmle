...
Here we specify:
 ...
 through *intervene_function*. For a history-dependent treatment rule, declare
 any fixed/adherence *propensity_instructions* and additional
 *propensity_variables* in the same *protocol* call.
