...
TODO: The object contains no data yet.
      ...
      - Use the functions 'add_long_data' and 'discretize' to add and discretize the dates of outcome, censored and competing events and to the longitudinal data (covariates and treatment).
