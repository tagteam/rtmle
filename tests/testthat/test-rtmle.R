...
test_that("obsolete way of run rtmle on simulated data",{
    ...
    expect_equal(old$estimate$Main_analysis$Estimate,0.220619,tolerance = 0.001)
    expect_equal(old$estimate$Main_analysis$Standard_error,0.01502242,tolerance = 0.001)
})
