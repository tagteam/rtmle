...
##' @param name_id Name of the subject id variable
...
##' @param censored_label Label of the values of the censoring variable(s) that indicated that the data of the subject at this time interval are censored.
