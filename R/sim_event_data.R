...
#' Death (1), Censoring(2) and Change in Covariate Process(4). Death and Censoring are terminal events and Operation
...
#' the event number \eqn{k}, treatment \eqn{A}, and the indicator \eqn{L} for change in the covariate process. The
