...
#' are at risk for mutually exclusive types of failure. 3 events can take place, one of which can be
#' interpreted as censoring.
#'
#' @title Simulate Competing risk Data
#'
#' @param N A double of the number of individuals
#' @param beta A 2X3 matrix with the effect of L0 and Treatment on the three processes.
#' The columns represent Process 1, Process 2 and Process 3, while the rows represent L0 and Treatment.
