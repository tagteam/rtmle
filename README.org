...
and then step-by-step prepares the analysis by adding regimes of the
...
# [[https://www.r-pkg.org/badges/version/rtmle][CRAN_Status_Badge]] 
# [[https://CRAN.R-project.org/package=rtmle][![](https://cranlogs.r-pkg.org/badges/rtmle)]]
[[https://github.com/tagteam/rtmle/actions/workflows/R-CMD-check.yaml][R-CMD-check]]

#+TITLE: Development area for R-package rtmle
#+Author: 
#+Date: 
